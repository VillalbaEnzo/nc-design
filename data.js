...
// Le champ "Responsable" (distinct de "Responsable commercial") est retiré :
// quasi jamais rempli en pratique (1,4 % de l'Excel réel) et rôle redondant/
// non défini (voir VISION_APP_FINALE.md, "Champs de la fiche NC").
...
// Pas de liste "Origine" (Client/Fournisseur/Interne) : ce n'est pas un champ
// réel de la fiche NC (voir VISION_APP_FINALE.md, "Champs de la fiche NC").
// La catégorisation de l'origine est portée par "Type de NC" (NCE/NCI/NCF/
// SAV/Non recevable) ; "Client / fournisseur / interne" est un champ texte
// libre qui contient le nom du client ou du site concerné.
...
// Coefficients des sous-critères de l'indice de gravité — repris de la v1,
// PAS figés en dur : réglables depuis l'écran d'administration (voir
// VISION_APP_FINALE.md, bloc "Indice de gravité"). C'est ce coefficient qui
// pondère le niveau de chaque sous-critère pour calculer l'IG.
const GRAVITE_COEFFICIENTS = {
  "Sécurité": 5,
  "Utilisateur": 3,
  "Client": 3,
  "Impact poseur": 2,
...
const HISTORIQUE_SIMILAIRES = {
  m2: [
    { id: "NC2025-441", titre: "Rayure panneau HPL à réception", score: 94, champs: {
      ...
      cause: "Pièce endommagée", descriptionAnomalie: "Rayure de 12 cm sur panneau HPL constatée à la réception, avant assemblage.", action: "Renvoi pièces", responsableCommercial: "Pierre", niveauIndice: "Mineur" } },
    { id: "NC2024-198", titre: "Rayure carrosserie module toboggan", score: 89, champs: {
      ...
      cause: "Défaut de fabrication", descriptionAnomalie: "Rayure profonde sur le fût du toboggan, visible dès le déballage.", action: "Refabrication", responsableCommercial: "Charlotte", niveauIndice: "Moyen" } },
    { id: "NC2025-312", titre: "Éclat peinture panneau, transport", score: 82, champs: {
      ...
      cause: "Problème d'emballage", descriptionAnomalie: "Éclats de peinture sur un panneau, emballage insuffisant pour le transport.", action: "Réclamation au fournisseur", responsableCommercial: "Matthieu", niveauIndice: "Mineur" } },
    { id: "NC2023-076", titre: "Rayure profonde panneau de façade", score: 79, champs: {
      ...
      cause: "Défaut de montage sur site", descriptionAnomalie: "Rayure profonde constatée après montage, origine incertaine.", action: "Correction sur le site", responsableCommercial: "Laurent", niveauIndice: "Moyen" } },
    { id: "NC2025-503", titre: "Rayure superficielle toit de cabane", score: 74, champs: {
      ...
      cause: "Info client incorrecte", descriptionAnomalie: "Rayure superficielle signalée, finalement trace de feutre nettoyable.", action: "/", responsableCommercial: "Dominique", niveauIndice: "Aucun" } },
    { id: "NC2024-390", titre: "Choc léger panneau lors du déchargement", score: 71, champs: {
      ...
      cause: "Manquants sur site", descriptionAnomalie: "Choc léger constaté sur un panneau lors du déchargement du camion.", action: "Devis", responsableCommercial: "David", niveauIndice: "Mineur" } },
    { id: "NC2022-158", titre: "Rayure HPL due à un sanglage serré", score: 68, champs: {
      ...
      cause: "Non respect des délais", descriptionAnomalie: "Marque de sanglage trop serré ayant rayé le panneau pendant le transport.", action: "Mise à jour documents", responsableCommercial: "Vincent", niveauIndice: "Mineur" } },
    { id: "NC2025-021", titre: "Marque de frottement porte coulissante", score: 65, champs: {
      ...
      cause: "Info client incorrecte", descriptionAnomalie: "Marque de frottement signalée, usage normal de la porte coulissante.", action: "/", responsableCommercial: "Hakim", niveauIndice: "Aucun" } },
    { id: "NC2024-266", titre: "Éraflure bas de structure", score: 61, champs: {
      ...
      cause: "Rouille", descriptionAnomalie: "Éraflure en bas de structure ayant favorisé un point de rouille naissant.", action: "Correction sur le site", responsableCommercial: "Nadia", niveauIndice: "Mineur" } },
    { id: "NC2023-410", titre: "Rayure sur panneau arrière module", score: 58, champs: {
      ...
      cause: "Pièce endommagée", descriptionAnomalie: "Rayure sur le panneau arrière constatée dès réception du lot fournisseur.", action: "Réclamation au fournisseur", responsableCommercial: "Pierre", niveauIndice: "Mineur" } },
  ],
  m7: [
    { id: "NC2025-377", titre: "Grincement métallique portique à la mise en service", score: 91, champs: {
      ...
      cause: "Défaut de fabrication", descriptionAnomalie: "Grincement métallique constant sur le portique, dès la mise en service.", action: "Réclamation au fournisseur", responsableCommercial: "Charlotte", niveauIndice: "Mineur" } },
    { id: "NC2024-229", titre: "Cliquetis chaîne de balançoire", score: 84, champs: {
      ...
      cause: "Manquants en visserie", descriptionAnomalie: "Cliquetis de chaîne dû à une fixation mal serrée.", action: "Correction sur le site", responsableCommercial: "Matthieu", niveauIndice: "Mineur" } },
    { id: "NC2025-140", titre: "Bruit anormal axe de rotation manège", score: 77, champs: {
      ...
      cause: "Erreur de conception", descriptionAnomalie: "Bruit anormal de l'axe de rotation, jeu mécanique trop important.", action: "Mise à jour conception", responsableCommercial: "Laurent", niveauIndice: "Moyen" } },
    { id: "NC2023-355", titre: "Grincement intermittent structure serrurerie", score: 73, champs: {
      ...
      cause: "Défaut de montage sur site", descriptionAnomalie: "Grincement intermittent selon la météo, jonctions métalliques à revoir.", action: "Correction sur le site", responsableCommercial: "Dominique", niveauIndice: "Mineur" } },
    { id: "NC2024-088", titre: "Vibration portique par grand vent", score: 69, champs: {
      ...
      cause: "Info client incorrecte", descriptionAnomalie: "Vibration signalée par vent fort, comportement normal de la structure.", action: "/", responsableCommercial: "David", niveauIndice: "Aucun" } },
    { id: "NC2022-301", titre: "Sifflement toboggan tube métallique", score: 66, champs: {
      ...
      cause: "Défaut de fabrication", descriptionAnomalie: "Sifflement du vent dans le tube métallique du toboggan, ébavurage insuffisant.", action: "Réclamation au fournisseur", responsableCommercial: "Vincent", niveauIndice: "Mineur" } },
    { id: "NC2025-459", titre: "Claquement fixation balançoire", score: 63, champs: {
      ...
      cause: "Manquants en visserie", descriptionAnomalie: "Claquement au niveau de la fixation haute de la balançoire.", action: "Achat matériel", responsableCommercial: "Hakim", niveauIndice: "Mineur" } },
    { id: "NC2024-512", titre: "Bruit anormal roulement tourniquet", score: 60, champs: {
      ...
      cause: "Défaut de fabrication", descriptionAnomalie: "Bruit de roulement anormal sur le tourniquet, graissage insuffisant en sortie d'atelier.", action: "Mise à jour documents", responsableCommercial: "Nadia", niveauIndice: "Mineur" } },
    { id: "NC2023-199", titre: "Grincement portillon accès structure", score: 57, champs: {
      ...
      cause: "Défaut de montage sur site", descriptionAnomalie: "Grincement du portillon d'accès, charnières à régler.", action: "Correction sur le site", responsableCommercial: "Pierre", niveauIndice: "Mineur" } },
    { id: "NC2021-233", titre: "Cliquetis chaîne portique", score: 54, champs: {
      ...
      cause: "Manquants en visserie", descriptionAnomalie: "Cliquetis de chaîne sur portique, resserrage nécessaire.", action: "Correction sur le site", responsableCommercial: "Charlotte", niveauIndice: "Mineur" } },
  ],
  m11: [
    { id: "NC2024-347", titre: "Odeur plastique module rotomoulé neuf", score: 87, champs: {
      ...
      cause: "Défaut de fabrication", descriptionAnomalie: "Odeur de plastique marquée sur un module rotomoulé neuf, atténuée après 3 semaines.", action: "Réclamation au fournisseur", responsableCommercial: "Matthieu", niveauIndice: "Mineur" } },
    { id: "NC2023-288", titre: "Odeur forte cabane exposée au soleil", score: 75, champs: {
      ...
      cause: "Info client incorrecte", descriptionAnomalie: "Odeur forte en plein soleil, dissipée après aération, non lié à un défaut matière.", action: "/", responsableCommercial: "Laurent", niveauIndice: "Aucun" } },
    { id: "NC2025-062", titre: "Odeur persistante toboggan plastique", score: 70, champs: {
      ...
      cause: "Défaut de fabrication", descriptionAnomalie: "Odeur persistante sur toboggan plastique, matière première suspectée.", action: "Réclamation au fournisseur", responsableCommercial: "Dominique", niveauIndice: "Mineur" } },
    { id: "NC2022-411", titre: "Odeur matière neuve module de jeu", score: 66, champs: {
      ...
      cause: "Info client incorrecte", descriptionAnomalie: "Odeur de matière neuve normale, dissipée après une semaine d'utilisation.", action: "/", responsableCommercial: "David", niveauIndice: "Aucun" } },
    { id: "NC2024-190", titre: "Odeur résine structure composite", score: 62, champs: {
      ...
      cause: "Erreur de conception", descriptionAnomalie: "Odeur de résine sur structure composite, formulation à revoir avec le fournisseur.", action: "Mise à jour conception", responsableCommercial: "Vincent", niveauIndice: "Moyen" } },
    { id: "NC2023-097", titre: "Odeur colle assemblage panneau", score: 59, champs: {
      ...
      cause: "Défaut de fabrication", descriptionAnomalie: "Odeur de colle sur panneau assemblé, séchage insuffisant avant expédition.", action: "Mise à jour documents", responsableCommercial: "Hakim", niveauIndice: "Mineur" } },
    { id: "NC2025-233", titre: "Odeur caoutchouc revêtement sol souple", score: 55, champs: {
      ...
      cause: "Défaut de fabrication", descriptionAnomalie: "Odeur de caoutchouc marquée sur le revêtement de sol souple livré.", action: "Réclamation au fournisseur", responsableCommercial: "Nadia", niveauIndice: "Mineur" } },
    { id: "NC2021-176", titre: "Odeur persistante bac à sable plastique", score: 52, champs: {
      ...
      cause: "Info client incorrecte", descriptionAnomalie: "Odeur de plastique neuf sur bac à sable, dissipée naturellement.", action: "/", responsableCommercial: "Pierre", niveauIndice: "Aucun" } },
    { id: "NC2024-405", titre: "Odeur électrique éclairage structure", score: 49, champs: {
      ...
      cause: "Défaut de fabrication", descriptionAnomalie: "Légère odeur électrique au niveau du bloc d'éclairage, composant à remplacer.", action: "Renvoi pièces", responsableCommercial: "Charlotte", niveauIndice: "Moyen" } },
    { id: "NC2022-064", titre: "Odeur plastique fondu élément toboggan", score: 46, champs: {
      ...
      cause: "Défaut de fabrication", descriptionAnomalie: "Odeur de plastique fondu sur un élément, défaut de moulage suspecté.", action: "Réclamation au fournisseur", responsableCommercial: "Matthieu", niveauIndice: "Mineur" } },
  ],
};
...
// ---- Référentiel Commandes (export hebdomadaire commercial) ----------------
// Voir VISION_APP_FINALE.md, section "Référentiel Commandes — vérification et
// complément d'information". Deux usages : aide à la vérification quand un
// numéro de commande apparaît sur une NC (signal, jamais une correction
// silencieuse), et complément d'information consultatif à la demande dans
// l'espace Suivi (bouton à côté de "N° Commande concernée"). L'import réel
// est hebdomadaire et append-only (une commande peut réapparaître plusieurs
// semaines de suite) — ici une seule "photo" par commande suffit pour la
// maquette.
const REFERENTIEL_COMMANDES = {
  "30822": { client: "Camping des Pins", responsableCommercial: "Charlotte", semaine: "2026-S24", dateExportEstimee: "2026-06-19", prix: "8 420 €", sol: "Copeaux de bois", couleur: "Vert sapin / Beige", contenu: "1 toboggan TOB-1204 + structure portique associée" },
  "30990": { client: "Groupe Cordelia Aménagement", responsableCommercial: "Matthieu", semaine: "2026-S25", dateExportEstimee: "2026-06-28", prix: "5 980 €", sol: "Gazon synthétique", couleur: "Rouge / Gris anthracite", contenu: "1 portique PORT-556 + 2 balançoires" },
  "30510": { client: "Mairie de Vallonne", responsableCommercial: "Laurent", semaine: "2026-S20", dateExportEstimee: "2026-05-22", prix: "12 300 €", sol: "Dalles amortissantes", couleur: "Bleu / Blanc", contenu: "1 structure de jeux STR-220 modulaire" },
  "31088": { client: "Groupe Cordelia Aménagement", responsableCommercial: "Vincent", semaine: "2026-S33", dateExportEstimee: "2026-08-21", prix: "3 150 €", sol: "Sable stabilisé", couleur: "Jaune / Vert", contenu: "2 balançoires BAL-210" },
  "31190": { client: "Village Vacances Les Tilleuls", responsableCommercial: "Dominique", semaine: "2026-S34", dateExportEstimee: "2026-08-24", prix: "6 740 €", sol: "Copeaux de bois", couleur: "Marron / Beige", contenu: "1 cabane CAB-402" },
  "30340": { client: "Espace Détente Nord", responsableCommercial: "Laurent", semaine: "2026-S18", dateExportEstimee: "2026-05-06", prix: "9 100 €", sol: "Gazon synthétique", couleur: "Gris anthracite / Rouge", contenu: "1 portique PORT-118" },
  "30288": { client: "Village Vacances Les Tilleuls", responsableCommercial: "Nadia", semaine: "2026-S17", dateExportEstimee: "2026-04-29", prix: "7 460 €", sol: "Dalles amortissantes", couleur: "Bleu / Beige", contenu: "1 structure STR-090" },
  "29765": { client: "Commune de Sainte-Row", responsableCommercial: "Vincent", semaine: "2026-S09", dateExportEstimee: "2026-03-04", prix: "4 280 €", sol: "Sable stabilisé", couleur: "Beige / Marron", contenu: "Panneaux HPL-118 (façade)" },
  "31240": { client: "Récréa Loisirs SAS", responsableCommercial: "Vincent", semaine: "2026-S35", dateExportEstimee: "2026-08-28", prix: "2 890 €", sol: "Gazon synthétique", couleur: "Vert / Blanc", contenu: "Panneaux HPL-330" },
};
    ...
    versions: [
      {
        ...
        mailId: null,
        verified: true,
        champs: { typeNC: "NCE", cause: "Défaut de fabrication", action: "Correction sur le site", niveauIndice: "Mineur" },
        journal: {
    ...
    versions: [
      {
        ...
        mailId: null,
        verified: true,
        champs: { typeNC: "SAV", cause: "Défaut de montage sur site", action: "Correction sur le site", niveauIndice: "Mineur" },
        journal: {
      ...
      },
      {
        ...
        mailId: "m6",
        verified: false,
        champs: { typeNC: "SAV", cause: "Défaut de montage sur site", action: "Correction sur le site", niveauIndice: "Moyen" },
        journal: {
    ...
    versions: [
      {
        ...
        mailId: null,
        verified: true,
        champs: { typeNC: "NCI", cause: "Erreur de conception", action: "Mise à jour conception", niveauIndice: "Moyen" },
        journal: {
    ...
    versions: [
      {
        ...
        mailId: "m7",
        verified: true,
        champs: { typeNC: "NCE", cause: "Défaut de fabrication", action: "Réclamation au fournisseur", niveauIndice: "Mineur" },
        journal: {
    ...
    versions: [
      {
        ...
        mailId: "m11",
        verified: false,
        champs: { typeNC: "NCF", cause: "Défaut de fabrication", action: "Réclamation au fournisseur", niveauIndice: "Mineur" },
        journal: {
    ...
    versions: [
      {
        ...
        mailId: null,
        verified: true,
        champs: { typeNC: "NCI", cause: "Manquants en visserie", action: "Achat matériel", niveauIndice: "Mineur" },
        journal: {
    ...
    versions: [
      {
        ...
        mailId: null,
        verified: true,
        champs: { typeNC: "NCF", cause: "Pièce endommagée", action: "Renvoi pièces", niveauIndice: "Moyen" },
        journal: {
